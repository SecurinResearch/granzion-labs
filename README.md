...
- **6 High-Impact MCP Servers**: Identity, Agent Card, Memory (RAG), Data (SQL), Comms (A2A), Infra.
...
- **[ONBOARDING.md](docs/ONBOARDING.md)**: Single-page onboarding — QUICKSTART, diagrams, identity testing, scenarios
